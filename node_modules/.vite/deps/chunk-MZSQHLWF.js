...
var Portal = React37.forwardRef(function Portal2(props, ref) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime18.jsx)(React37.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime18.jsx)(React37.Fragment, {
...
var ModalUnstyled = React38.forwardRef(function ModalUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime19.jsx)(
    Portal_default,
    {
      ...
      children: (0, import_jsx_runtime20.jsxs)(Root, _extends({}, rootProps, {
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime19.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime19.jsx)(FocusTrap_default, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(React39.Fragment, {
...
var TextareaAutosize = React40.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const getUpdatedState = React40.useCallback(() => {
...
var BadgeUnstyled = React41.forwardRef(function BadgeUnstyled2(props, ref) {
  const {
    component,
    children,
    max: maxProp = 99,
...
function useButton(parameters) {
  ...
  const [hostElementName, setHostElementName] = React42.useState("");
  ...
  const updateHostElementName = React42.useCallback((instance) => {
...
var ButtonUnstyled = React43.forwardRef(function ButtonUnstyled2(props, forwardedRef) {
  var _ref;
  const {
    action,
    children,
...
var FormControlUnstyledContext = React44.createContext(void 0);
if (true) {
...
var FormControlUnstyled = React45.forwardRef(function FormControlUnstyled2(props, ref) {
  var _ref;
  const {
    defaultValue,
    children,
...
function useFormControlUnstyledContext() {
  return React46.useContext(FormControlUnstyledContext_default);
}
...
var InputUnstyled = React48.forwardRef(function InputUnstyled2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps({
    ...
    }, multiline && !isHostComponent_default2(Input) && {
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const [nextState, dispatch] = React49.useReducer(combinedReducer, initialState);
  const dispatchWithProps = React49.useCallback((action) => {
    dispatch(_extends({
      props: props.current
    }, action));
  }, [dispatch, props]);
  const previousState = React49.useRef(initialState);
  React49.useEffect(() => {
...
function useListbox(props) {
  ...
  const id = useId(idProp);
  const defaultIdGenerator = React52.useCallback((_, index) => `${id}-option-${index}`, [id]);
  ...
  const highlightedIndex = React52.useMemo(() => {
  ...
  const previousOptions = React52.useRef([]);
  React52.useEffect(() => {
  ...
  const setSelectedValue = React52.useCallback((option) => {
    dispatch({
      type: ActionTypes.setValue,
      event: null,
      value: option
  ...
  const setHighlightedValue = React52.useCallback((option) => {
    dispatch({
  ...
  const createHandleOptionClick = React52.useCallback((option, other) => (event) => {
    var _other$onClick;
  ...
  const createHandleOptionPointerOver = React52.useCallback((option, other) => (event) => {
  ...
  const getOptionState = React52.useCallback((option) => {
    let selected;
  ...
  const getOptionTabIndex = React52.useCallback((optionState) => {
    if (focusManagement === "activeDescendant") {
      return void 0;
    }
  ...
  const getOptionProps = React52.useCallback((option, otherHandlers = {}) => {
...
var MenuUnstyledContext = React53.createContext(null);
...
function useMenuChangeNotifiers() {
  ...
  const notifyHighlightChanged = React55.useCallback((newValue) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newValue);
  }, [messageBus]);
  const registerHighlightChangeHandler = React55.useCallback((handler) => {
...
function useMenu(parameters = {}) {
  ...
  const [menuItems, setMenuItems] = React56.useState({});
  const listboxRef = React56.useRef(null);
  const handleRef = useForkRef(listboxRef, listboxRefProp);
  const registerItem = React56.useCallback((id, metadata) => {
  ...
  const unregisterItem = React56.useCallback((id) => {
    setMenuItems((previousState) => {
      const newState = _extends({}, previousState);
      delete newState[id];
      return newState;
  ...
  const highlightFirstItem = React56.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
      setListboxHighlight(menuItems[Object.keys(menuItems)[0]].id);
    }
  }, [menuItems, setListboxHighlight]);
  const highlightLastItem = React56.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
  ...
  const getItemState = React56.useCallback((id) => {
    const {
      disabled,
      highlighted
    } = getOptionState(id);
...
var PopperTooltip = React57.forwardRef(function PopperTooltip2(props, ref) {
  var _ref;
  const {
    anchorEl,
    children,
...
var PopperUnstyled = React57.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
var MenuUnstyled = React58.forwardRef(function MenuUnstyled2(props, forwardedRef) {
  ...
  const menuContextValue = React58.useMemo(() => _extends({}, contextValue, {
    open
  }), [contextValue, open]);
  return (0, import_jsx_runtime31.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime31.jsx)(Listbox, _extends({}, listboxProps, {
      children: (0, import_jsx_runtime31.jsx)(MenuUnstyledContext_default.Provider, {
...
function useMenuItem(props) {
  ...
  const id = useId();
  const menuContext = React60.useContext(MenuUnstyledContext_default);
  ...
  const [focusRequested, requestFocus] = React60.useState(false);
  const focusIfRequested = React60.useCallback(() => {
...
var MenuItemUnstyled = React61.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled: disabledProp = false,
...
function getOptionsFromChildren(children) {
  ...
  React62.Children.forEach(children, (node2) => {
...
function useSelectChangeNotifiers() {
  const messageBus = useMessageBus();
  const notifySelectionChanged = React63.useCallback((newValue) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newValue);
  }, [messageBus]);
  const notifyHighlightChanged = React63.useCallback((newValue) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC2, newValue);
  }, [messageBus]);
  const registerSelectionChangeHandler = React63.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React63.useCallback((handler) => {
...
function useSelect(props) {
  ...
  const optionsMap = React64.useMemo(() => {
  ...
  const createHandleListboxItemClick = React64.useCallback((otherHandlers) => (event) => {
    var _otherHandlers$onClic2;
  ...
  const listboxReducer = React64.useCallback((state, action) => {
    const newState = defaultListboxReducer(state, action);
  ...
  const optionValues = React64.useMemo(() => options.map((o) => o.value), [options]);
  let useListboxParameters;
  const isOptionDisabled = React64.useCallback((valueToCheck) => {
  ...
  const getOptionProps = React64.useCallback((optionValue, otherHandlers = {}) => {
...
var SelectUnstyledContext = React65.createContext(void 0);
...
function defaultRenderMultipleValues(selectedOptions) {
  return (0, import_jsx_runtime33.jsx)(React66.Fragment, {
...
var MultiSelectUnstyled = React66.forwardRef(function MultiSelectUnstyled2(props, forwardedRef) {
  ...
  const handleOpenChange = React66.useCallback((isOpen) => {
  ...
  const selectedOptions = React66.useMemo(() => {
    if (value == null) {
      return [];
    }
  ...
  const context = React66.useMemo(() => _extends({}, contextValue, {
    listboxRef
  }), [contextValue]);
  return (0, import_jsx_runtime34.jsxs)(React66.Fragment, {
...
true ? MultiSelectUnstyled.propTypes = {
   ...
   * @default []
   */
  defaultValue: import_prop_types34.default.array,
  /**
   ...
   */
  value: import_prop_types34.default.array
} : void 0;
...
var OptionGroupUnstyled = React67.forwardRef(function OptionGroupUnstyled2(props, ref) {
  const {
    component,
    disabled = false,
    slotProps = {},
  ...
  return (0, import_jsx_runtime36.jsxs)(Root, _extends({}, rootProps, {
    ...
    })), (0, import_jsx_runtime35.jsx)(List, _extends({}, listProps, {
...
function useOption(params) {
  ...
  const selectContext = React68.useContext(SelectUnstyledContext);
  if (!selectContext) {
...
var OptionUnstyled = React69.forwardRef(function OptionUnstyled2(props, ref) {
  const {
    children,
    component,
    disabled = false,
...
var OptionUnstyled_default = React69.memo(OptionUnstyled);
...
var SelectUnstyled = React70.forwardRef(function SelectUnstyled2(props, forwardedRef) {
  var _ref, _slots$listbox, _slots$popper;
  const {
    autoFocus,
    children,
  ...
  const [groupedOptions, setGroupedOptions] = React70.useState([]);
  const options = React70.useMemo(() => flattenOptionGroups(groupedOptions), [groupedOptions]);
  const [listboxOpen, setListboxOpen] = useControlled({
    controlled: listboxOpenProp,
    default: defaultListboxOpen,
    name: "SelectUnstyled",
  ...
  const handleOpenChange = React70.useCallback((isOpen) => {
    setListboxOpen(isOpen);
    onListboxOpenChange == null ? void 0 : onListboxOpenChange(isOpen);
  }, [setListboxOpen, onListboxOpenChange]);
  const {
  ...
  return (0, import_jsx_runtime39.jsxs)(React70.Fragment, {
    children: [(0, import_jsx_runtime38.jsx)(Button, _extends({}, buttonProps, {
      children: renderValue(selectedOption)
    })), buttonDefined && (0, import_jsx_runtime38.jsx)(Popper, _extends({}, popperProps, {
      children: (0, import_jsx_runtime38.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime38.jsx)(SelectUnstyledContext.Provider, {
          value: contextValue,
          children
        })
      }))
    })), name && (0, import_jsx_runtime38.jsx)("input", {
      type: "hidden",
      name,
...
true ? SelectUnstyled.propTypes = {
   ...
   * @default defaultOptionStringifier
   */
  optionStringifier: import_prop_types37.default.func,
  /**
...
var SliderUnstyled = React72.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime40.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime40.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime41.jsxs)(React72.Fragment, {
      ...
      return (0, import_jsx_runtime41.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime40.jsx)(Input, _extends({
          "data-index": index,
          ...
          value: values2[index]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime40.jsx)(ValueLabel, _extends({}, !isHostComponent_default2(ValueLabel) && {
          valueLabelFormat,
          index,
          disabled
        }, valueLabelProps, {
...
var SnackbarUnstyled = React74.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children,
    component,
  ...
  return (0, import_jsx_runtime42.jsx)(ClickAwayListener_default, _extends({}, clickAwayListenerProps, {
...
var SwitchUnstyled = React76.forwardRef(function SwitchUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime43.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime43.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime43.jsx)(Input, _extends({}, inputProps))]
  }));
});
...
function LastPageIconDefault() {
  return _span || (_span = (0, import_jsx_runtime45.jsx)("span", {
    children: "⇾|"
  }));
}
...
var TablePaginationActionsUnstyled = React77.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var TablePaginationUnstyled = React78.forwardRef(function TablePaginationUnstyled2(props, ref) {
  ...
  let colSpan;
  if (!component || component === "td" || !isHostComponent_default2(component)) {
  ...
  return (0, import_jsx_runtime47.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime48.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime47.jsx)(Select, _extends({}, selectProps, {
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react8.createElement)(MenuItem, _extends({}, menuItemProps, {
...
function useTabs(parameters) {
  ...
  const onSelected = React79.useCallback((e, newValue) => {
    setValue(newValue);
    if (onChange) {
      onChange(e, newValue);
    }
  }, [onChange, setValue]);
  const tabsContextValue = React79.useMemo(() => {
    return {
      idPrefix,
      value,
      onSelected,
...
var Context = React80.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React80.useContext(Context);
}
...
var TabsUnstyled = React81.forwardRef((props, ref) => {
  var _ref;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime49.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime49.jsx)(TabsContext_default.Provider, {
...
true ? TabsUnstyled.propTypes = {
   ...
   * The default value. Use when the component is not controlled.
   */
  defaultValue: import_prop_types42.default.oneOfType([import_prop_types42.default.oneOf([false]), import_prop_types42.default.number, import_prop_types42.default.string]),
  /**
   ...
   */
  value: import_prop_types42.default.oneOfType([import_prop_types42.default.oneOf([false]), import_prop_types42.default.number, import_prop_types42.default.string])
} : void 0;
...
var TabPanelUnstyled = React82.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
true ? TabPanelUnstyled.propTypes = {
   ...
   */
  value: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]).isRequired
} : void 0;
...
function useTabsList(parameters) {
  ...
  const tabsListRef = React83.createRef();
  ...
  const processChildren = React83.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React83.Children.map(children, (child) => {
...
var TabsListUnstyled = React84.forwardRef((props, ref) => {
  var _ref;
  const {
    component,
    slotProps = {},
  ...
  return (0, import_jsx_runtime51.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
...
var TabUnstyled = React85.forwardRef(function TabUnstyled2(props, ref) {
  var _ref;
  const {
    action,
    children,
  ...
  React85.useImperativeHandle(action, () => ({
    focusVisible: () => {
      setFocusVisible(true);
...
var SvgIcon = React86.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime54.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [children, titleAccess ? (0, import_jsx_runtime53.jsx)("title", {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MZSQHLWF.js.map
